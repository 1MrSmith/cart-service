...
VALUES ('MrSmith', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidXNlciI6Ik1yU21pdGgiLCJwYXNzd29yZCI6IlRFU1RfUEFTU1dPUkQiLCJpYXQiOjE1MTYyMzkwMjJ9.XmAQEqIMxKZPov2eJdROcjVj_qfkNivH5iAytJHh2U4');

INSERT INTO "products"("id","title", "description", "price")
VALUES ('163f0682-7d24-42e4-af32-e110fbdfd4cb',
...
SELECT (SELECT id FROM carts WHERE status = 'OPEN' LIMIT 1),
       (SELECT id FROM products where title = '5 Centimes 1864 copy'),
       1;

INSERT INTO "orders"("cart_id", "user_id", "payment", "delivery", "comments", "status", "total")
SELECT (SELECT id FROM carts WHERE status = 'OPEN' LIMIT 1),
       (SELECT id FROM "users" WHERE name = 'MrSmith'),
